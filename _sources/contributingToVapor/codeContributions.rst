...
This is an alternative to downloading our pre-built libraries that allows you to configure and store them wherever you want.  See ~/VAPOR/scripts/build3rdParty.sh to compile the libraries and see specifics on how they are configured for maxOSx86, appleSilicon, and Linux.
...
The source code for these libraries may be downloaded :ref:`here <Third Party Libraries>`
